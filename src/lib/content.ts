      ...
      episodes: [
        {
          ...
          number: 1,
          title: 'ВОДА',
          synopsis: 'Олег «Дон Кіхот» Грабар — музикант, що обрав передову.',
        ...
        },
        {
          ...
          number: 2,
          title: 'ВОГОНЬ',
          synopsis: 'Павло «Капелан» Вишебаба — художник у камуфляжі.',
        ...
        },
        {
          ...
          number: 3,
          title: 'ПОВІТРЯ',
          synopsis: 'Стас «Ткач» — актор, що грає найважливішу роль.',
        ...
        },
        {
          ...
          number: 4,
          title: 'ЗЕМЛЯ',
          synopsis: 'Снайперка і мати. Слова, що народжуються між боями.',
      ...
      episodes: [
        {
          ...
          number: 1,
          title: 'WATER',
          synopsis: 'Oleh "Don Quixote" Grabar — musician who chose the front.',
          youtubeId: 'ORS1Oh_iRV0',
          youtubeUrl: 'https://www.youtube.com/watch?v=ORS1Oh_iRV0',
          hasAudioDesc: true,
          hasEnglish: true,
        ...
        },
        {
          ...
          number: 2,
          title: 'FIRE',
          synopsis: 'Pavlo "Kapelan" Vyshebaba — artist in camouflage.',
          youtubeId: 'j697xh6tXsU',
          youtubeUrl: 'https://www.youtube.com/watch?v=j697xh6tXsU',
          hasAudioDesc: true,
          hasEnglish: true,
        ...
        },
        {
          ...
          number: 3,
          title: 'AIR',
          synopsis: 'Stas "Tkach" — actor playing the most important role.',
          youtubeId: '0Z0vQ_mbXqA',
          youtubeUrl: 'https://www.youtube.com/watch?v=0Z0vQ_mbXqA',
          hasAudioDesc: false,
          hasEnglish: true,
        ...
        },
        {
          ...
          number: 4,
          title: 'EARTH',
          synopsis: 'A sniper and a mother. Defending the homeland.',
          youtubeId: '-3geo8Gjy5o',
          youtubeUrl: 'https://www.youtube.com/watch?v=-3geo8Gjy5o',
          hasAudioDesc: false,
          hasEnglish: true,
